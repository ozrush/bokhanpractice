...
INSERT INTO Document_type (id, version, name) VALUES (1, 0, 'Паспорт');
INSERT INTO Document_type (id, version, name) VALUES (2, 0, 'Военный билет');
INSERT INTO Document_type (id, version, name) VALUES (3, 0, 'Свидетельство о рождении');
INSERT INTO Document_type (id, version, name) VALUES (4, 0, 'Удостоверение беженца');
